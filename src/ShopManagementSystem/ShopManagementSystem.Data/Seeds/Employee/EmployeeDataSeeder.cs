...
public class EmployeeDataSeeder
{
    public static void SeedEmployeeData(ApplicationDbContext context)
    {
        ...
        var employees = new List<Employee>
        {
            ...
            new Employee { FirstName = "Clark", LastName = "Kent", Post = "Seller", UserId = Guid.Parse("1A032BFD-8FCC-42EC-8B59-4233B63FB939"), ShopId = Guid.Parse("4F8B0BED-DF39-47C9-9A6D-87BD6917CDAE")}
        };
